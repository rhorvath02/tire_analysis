...
coeffs = [1.351280954310543, 2.2476529305423965, -0.8509484823458834, 12.336123849123595, -0.5526590796664804, -1.4566689238399961, -0.04434258610672221, -0.36609019329529896, 48.73023518936532, 34.8045614586387, -1.0992123979938666, -0.003292949625684342, -0.006907553737528136, -0.08734932112093803, -0.04704948793424146]

pure_long_coeffs = coeffs[0:15]

combined_long_coeffs = [6.701679824892427, 8.017951012667416, 1.0000000295787526, -7.620470441623948, 0.0, 0.0]
...
for name, tire in tires.items():
    try:
        ...
        tire["long"] = df[(df["pressure"] == pressure) & (df["velocity"] == velocity) & (df["camber"] == 0) & (df["load"] == -1112.0551223483046)]
        # print(tire["long"])
