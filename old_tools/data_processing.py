...
import numpy as np
import pandas as pd
import old_tools.data_helpers as data_helpers
...
def main():
    ...
    # Camber sweeps
    l1 = np.array([0, 2, 4])
    l2 = np.array([0, -4, 0, 4, 0])

    # Slip ratio sweeps
    B3 = np.array([0.15, -0.15, 0.15])
    ...
    data_map = {"cornering_hoosier_18x6_10x7_run1": {"file_path" : "tire_data/raw_data/Round9/B2356raw31.mat", 
                                                            "sweeps" : create_sweep_dict(L1, l1, P, V1, S1), "avg": True},

                "braking_hoosier_18x6_10x7_run1": {"file_path" : "tire_data/raw_data/Round9/B2356raw72.mat", 
                                                            "sweeps" : create_sweep_dict(L3, l1, P, V1, S3), "avg": True}
                }
